...
__doc__ = """a simple SOCKS4 server framework"""
########slim down code
######test everything
########integrate CLI
...
class SOCKS4ConnectionHandler(baseserver.eventhandler.ConnectionHandler):
    """handler explicitly for SOCKS4 control connections"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            if wrapped_conn: # authenticated/authorized
                ...
                self.request_handler = SOCKS4ConnectionHandler.CMD_TO_HANDLER[
...
class SOCKS4Server(baseserver.baseserver.BaseServer):
    def __init__(self, address = baseserver.baseserver.best_address(),
            event_handler_class = SOCKS4ConnectionHandler, name = "SOCKS4",
...
if __name__ == "__main__":
    ...
    server = SOCKS4Server(address = ("::1", 1080, 0 , 0), **config)
